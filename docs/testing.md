...
- deployers
  ...
  - `disapp-recipe`: OCM discovered application deployed using recipe without any hooks by the test command.
  - `disapp-recipe-check`: OCM discovered application deployed using recipe with check hooks by the test command.
  - `disapp-recipe-exec`: OCM discovered application deployed using recipe with exec hooks by the test command.
  - `disapp-recipe-check-exec`: OCM discovered application deployed using recipe with check and exec hooks by the test command.
- pvcSpecs:
